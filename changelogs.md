...
**There's a chance your existing world will get converted to a vanilla world & some dimensions will stop working, follow this link if that's the case:** https://gist.github.com/Gbergz/a63c4ae91dff1174ecca39462c915418 !
...
**Changes**
- Quark's Big Dungeon should now no longer generate in wrong dimensions or biomes.
- Disabled the **@Occultism** Deepslate Silver Ore.
- Some changes in mod updates. 


**Fixes**
- Crashes when forming an Immersive Engineering Multiblock has been fixed.
...
**Changes**
- Disabled Excavation auto pickup, as it caused some issues.
- Some changes in mod updates. 


**Fixes**
- An ExtraStorage crash related to Advanced Importers has been fixed.
- Fixed Charcoal Block recipe conflict.
- Fixes in mod updates. 
...
- [Silent's Gems](https://www.curseforge.com/minecraft/mc-mods/silents-gems)
- [Supplementaries](https://www.curseforge.com/minecraft/mc-mods/supplementaries) (+ [Selene Lib](https://www.curseforge.com/minecraft/mc-mods/selene))
...
**Changes**
- You're now able to **pick** your **enchantments** manually in the new **Enchantment Infuser**. (**No more randomness!**)
- There will now be a green check mark in the server list if server is joinable. (**Red X if not.**)
- Newly picked up **items** are now **highlighted** in inventory with a little **star**.
- Most loot chests found around the world are now **per-player, per-chest**. (**Loot for everybody!**)
- **Nether Ores** & some other new **Ores** now generate.
- Some changes in mod updates. 
...
**Updated**
- **Forge** from version **38.0.14** to **38.0.17**
- All mods that could be updated have been updated.
